...
beautiful.init("/home/mrquatrelle/.config/awesome/theme.lua")
...
globalkeys = gears.table.join(
    ...
    -- Layout manipulation
    awful.key({ modkey,  "Shift"  }, "s",  function() awful.spawn.with_shell("xscreensaver-command -lock") end,
              {description="lock screensaver (xscreensaver)", group="client"}),
    awful.key({ modkey, "Shift"   }, "ç", function () awful.client.swap.byidx(  1)    end,
...
awful.rules.rules = {
    ...
    { rule = { class = "discord" },
    	properties = { screen = 1, tag = "coms" } },

    -- Set Spotify to always map on the tag named "2" on screen 1.
    { rule = { class = "ppotify" },
    	properties = { screen = 1, tag = "music" } },

    -- Set PulseEffects to always map on the tag named "2" on screen 1.
